...
AjfImageModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.4", ngImport: i0, type: AjfImageModule, declarations: [AjfImage], imports: [CommonModule, MatIconModule], exports: [AjfImage] });
AjfImageModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AjfImageModule, imports: [CommonModule, MatIconModule] });

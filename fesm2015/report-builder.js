...
import { InjectionToken, EventEmitter, Injectable, Optional, Inject, Input, Component, ViewEncapsulation, ChangeDetectionStrategy, ViewChild, ChangeDetectorRef, Pipe, Output, forwardRef, ElementRef, Renderer2, NgModule } from '@angular/core';
...
let AjfImageFilterPipe = /** @class */ (() => {
    let AjfImageFilterPipe = class AjfImageFilterPipe {

...
import { Component, ChangeDetectionStrategy, ViewEncapsulation, EventEmitter, Output, Injectable, NgModule } from '@angular/core';
import * as i2 from '@ajf/core/chart';
import { AjfChartModule } from '@ajf/core/chart';
import { filter, switchMap, distinctUntilChanged, debounceTime, skip, tap } from 'rxjs/operators';
    ...
    ngOnInit() {
        if (this.instance != null && this.instance.filter != null) {
            this._instanceSub = this._formRenderer.formGroup
                ...
                if (this.instance != null && this.instance.filter != null) {
                    const newConst = Object.assign(Object.assign({}, (this.instance.filter.context || {})), a);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: AjfFilterWidgetComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i1$1.TranslocoService }, { type: i2$1.AjfFormRendererService }]; }, propDecorators: { filteredInstance: [{
                type: Output
            }] } });
...
AjfTableWidgetComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.0.0-rc.3", type: AjfTableWidgetComponent, selector: "ng-component", usesInheritance: true, ngImport: i0, template: "<ajf-widget-export \n[widgetType]=\"instance.widgetType\" \n[data]=\"instance.data\"\n[enable]=\"instance.exportable\"\n>\n    <ajf-table [data]=\"instance.data\"></ajf-table>\n</ajf-widget-export>\n", styles: ["table{border-spacing:0}table td{padding:10px}\n"], components: [{ type: i1.AjfWidgetExport, selector: "ajf-widget-export", inputs: ["widgetType", "data", "overlay", "enable"] }, { type: i2$3.AjfTable, selector: "ajf-table", inputs: ["data", "cellpadding"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });

...
AjfBooleanFieldComponent.decorators = [
    { type: Component, args: [{template: "<mat-slide-toggle [formControl]=\"control|async\" [disabled]=\"readonly\"></mat-slide-toggle>",
                styles: [""],
                changeDetection: ChangeDetectionStrategy.OnPush,
                encapsulation: ViewEncapsulation.None,
            },] },
...
AjfDateFieldComponent.decorators = [
    { type: Component, args: [{template: "<ajf-calendar selectionMode=\"day\" dateOnlyForDay [minDate]=\"instance.node.minDate|ajfDateValue\" [maxDate]=\"instance.node.maxDate|ajfDateValue\" [formControl]=\"control|async\"></ajf-calendar>",
                styles: [""],
                changeDetection: ChangeDetectionStrategy.OnPush,
                encapsulation: ViewEncapsulation.None,
            },] },
...
AjfDateInputFieldComponent.decorators = [
    { type: Component, args: [{template: "<mat-form-field><input matInput type=\"date\" [attr.aria-label]=\"instance.node.label || (instance|ajfNodeCompleteName)\" [min]=\"instance.node.minDate|ajfDateValueString\" [max]=\"instance.node.maxDate|ajfDateValueString\" [readonly]=\"readonly\" (change)=\"onChange()\" [formControl]=\"control|async\"></mat-form-field>",
                styles: [""],
                changeDetection: ChangeDetectionStrategy.OnPush,
                encapsulation: ViewEncapsulation.None,
            },] },

...
export declare class AjfReportBuilderService {
    ...
    private _iconSets;
    readonly iconSets: AjfReportIcons;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly onDragged: Observable<any>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly onOver: Observable<any>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly fixedZoom: Observable<boolean>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly onDragEnter: Observable<any>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly report: Observable<AjfReport | null>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly columnWidthChanged: EventEmitter<void>;
    /**
    ...
    readonly emptyContent: Observable<boolean>;
    /**
     *
     * @param type
     * @param newWidget
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly formsVariables: Observable<AjfFormVariables[]>;
    readonly conditionNames: Observable<AjfFormVariables[]>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly getSaveReport: Observable<any>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly reportSaved: Observable<AjfReport>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly reportForms: Observable<AjfForm[]>;
    /**
     ...
     * @memberOf AjfReportBuilderService
     */
    readonly origin: Observable<string>;
    /**

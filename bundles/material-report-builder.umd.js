    ...
    ***************************************************************************** */
    ...
    var AjfReportBuilderService = /** @class */ (function () {
        ...
        function AjfReportBuilderService(reportsConfig) {
            ...
            this._origin = ((/** @type {?} */ (this._originUpdate))).pipe(operators.startWith('header'), operators.share());
            this._savedReport = ((/** @type {?} */ (this._savedReportUpdate))).pipe(operators.share());
            this._onDragged = ((/** @type {?} */ (this._onDraggedUpdate))).pipe(operators.startWith(false), operators.share());
            this._onOver = ((/** @type {?} */ (this._onOverUpdate))).pipe(operators.startWith(false), operators.share());
            this._fixedZoom = ((/** @type {?} */ (this._fixedZoomUpdate))).pipe(operators.startWith(false), operators.share());
            this._onDragEnter = this._onDragEnterUpdate.pipe(operators.share());
            this._reportStyles = ((/** @type {?} */ (this._reportStylesUpdate))).pipe(operators.scan((/**
             * @param {?} styles
             * @param {?} op
             * @return {?}
             */
            function (styles, op) {
                return op(styles);
            }), (/** @type {?} */ ({}))), operators.share(), operators.startWith((/** @type {?} */ ({}))));
            this._reportForms = ((/** @type {?} */ (this._reportFormsUpdate))).pipe(operators.scan((/**
             * @param {?} forms
             * @param {?} op
             * @return {?}
             */
             ...
             * @return {?}
             */
            function (s) { return s != null; })), operators.scan((/**
             * @param {?} variables
             * @param {?} op
             * @return {?}
             */
            ...
            this._headerWidgets = ((/** @type {?} */ (this._headerWidgetsUpdate))).pipe(operators.scan((/**
             * @param {?} widgets
             * @param {?} op
             * @return {?}
             */
            function (widgets, op) {
                return op(widgets);
            }), (/** @type {?} */ ({ widgets: [], styles: {} }))), operators.startWith((/** @type {?} */ ({ widgets: [], styles: {} }))), operators.publishReplay(1), operators.refCount());
            this._headerStyles = this._headerWidgets.pipe(operators.map((/**
             * @param {?} widgets
             * @return {?}
             */
            function (widgets) {
            ...
            this._contentStyles = this._contentWidgets.pipe(operators.map((/**
             * @param {?} widgets
             * @return {?}
             */
            function (widgets) {
            ...
            this._footerWidgets = ((/** @type {?} */ (this._footerWidgetsUpdate))).pipe(operators.scan((/**
             * @param {?} widgets
             * @param {?} op
             * @return {?}
             */
            ...
            this._footerStyles = this._footerWidgets.pipe(operators.map((/**
             * @param {?} widgets
             * @return {?}
             */
            function (widgets) {
            ...
            this._color = ((/** @type {?} */ (this._colorUpdate))).pipe(operators.scan((/**
             * @param {?} color
             * @param {?} op
             * @return {?}
             */
            ...
            this._currentWidget = ((/** @type {?} */ (this._currentWidgetUpdate))).pipe(operators.filter((/**
             * @param {?} s
             * @return {?}
             */
            function (s) { return s != null; })), operators.scan((/**
            ...
            function (widget, op) {
                return op(widget);
            }), undefined), operators.publishReplay(1), operators.refCount());
            this._reportForms.pipe(operators.filter((/**
             * @param {?} f
             * @return {?}
             */
            function (f) { return f.length != 0; })), operators.map((/**
             * @param {?} forms
             * @return {?}
             */
            function (forms) {
                ...
                function (_colors) {
                    ...
                    if (r == null) {
                        ...
                        for (var i = 0; i < r.header.content.length; i++) {
                            ...
                            if (obj instanceof reports.AjfReportLayoutWidget) {
                                /** @type {?} */
            ...
            this._saveReport.pipe(operators.map((/**
             * @param {?} json
             * @return {?}
             */
            function (json) {
            ...
            this._saveReportEvent.pipe(operators.combineLatest(this.report, this.reportForms), operators.combineLatest(this._headerWidgets.pipe(operators.filter((/**
             * @param {?} w
             * @return {?}
             */
            function (w) { return w != null; }))), this._contentWidgets.pipe(operators.filter((/**
             * @param {?} w
             * @return {?}
             */
            function (w) { return w != null; }))), this._footerWidgets.pipe(operators.filter((/**
             * @param {?} w
             * @return {?}
             */
            function (w) { return w != null; }))), this._reportStyles.pipe(operators.filter((/**
             * @param {?} w
             * @return {?}
             */
            ...
            function (r) {
                ...
                obj['styles'] = r[4];
                /** @type {?} */
                var ro = new reports.AjfReport(forms, {
                    header: new reports.AjfReportContainer({
                        content: r[1].widgets,
                        styles: r[1].styles
                    }),
                    content: new reports.AjfReportContainer({
                        content: r[2].widgets,
                        styles: r[2].styles
                    }),
                    footer: new reports.AjfReportContainer({
                        content: r[3].widgets,
                        styles: r[3].styles
                    }),
                    styles: r[4]
        ...
        function (nodes) {
            for (var i = 0; i < nodes.length; i++) {
                if (nodes[i] instanceof forms$1.AjfNodeGroup ||
                    nodes[i] instanceof forms$1.AjfSlide ||
                    nodes[i] instanceof forms$1.AjfRepeatingSlide ||
                    nodes[i] instanceof forms$1.AjfStringField) {
                    nodes.splice(i, 1);
                    i--;
                }
            }
        ...
        function (_label, _level, _mainIndex, _index, formulaText, aggregationType) {
            ...
            function (w) {
                ...
                if (widget != null && widget.dataset != null) {
                    /** @type {?} */
                    var formula = new models.AjfFormula();
                    /** @type {?} */
                    var aggregation = new reports.AjfAggregation();
                    // let obj: any;
        ...
        function () {
            ...
            function (widget) {
                ...
                myObj.content.push(new reports.AjfReportColumnWidget(columnObj));
                _this._saveReportEvent.emit();
                return myObj;
            }));
        };
        ...
        function (event, toColumn, position) {
            if (event.dragData && event.dragData.fromColumn != null) {
                ...
                /** @type {?} */
                var newWidget = reports.AjfReportWidget.fromJson(obj);
                if (position != null) {
                ...
                /** @type {?} */
                var obj = {
                    'widgetType': reports.AjfReportWidgetType[event.dragData]
                };
                /** @type {?} */
                var newWidget = reports.AjfReportWidget.fromJson(obj);
                if (position != null) {
    ...
    var AjfReportBuilderColumn = /** @class */ (function () {
        ...
        AjfReportBuilderColumn.decorators = [
            { type: core.Component, args: [{selector: 'ajf-column',
    ...
    function ajfWidgetTypeToLabel(type) {
        return ajfWidgetTypeStringToLabel(reports.AjfReportWidgetType[type]);
    }
    /**
     * @param {?} type
     * @return {?}
    ...
    function widgetReportBuilderIconName(type) {
        return "reportbuilder-" + reports.AjfReportWidgetType[type].toLowerCase();
    }
    /**
     * @param {?} str
     * @return {?}
    ...
    var AjfReportBuilderConditionEditor = /** @class */ (function () {
         ...
         */
        function () {
            return models.AjfCondition.validate(this.conditionText, this.names);
        };
        ...
        AjfReportBuilderConditionEditor.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-condition-editor',
    ...
    var AjfReportBuilderContent = /** @class */ (function () {
         ...
         */
        function (widget) {
            if (widget instanceof reports.AjfReportLayoutWidget) {
                return true;
            }
            else {
                return false;
        ...
        function (arrayTo, event, to) {
            ...
            if (itemData.fromColumn != null) {
                ...
                this.currentWidget = reports.AjfReportWidget.fromJson(JSON.parse(utils.deepCopy(itemData.json)));
            }
            else {
                /** @type {?} */
                var obj = {
                    'widgetType': ((/** @type {?} */ (reports.AjfReportWidgetType)))[(/** @type {?} */ (itemData.widgetType))]
                };
                this.currentWidget = reports.AjfReportWidget.fromJson(obj);
            }
            this.onDragEndHandler();
        ...
        AjfReportBuilderContent.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-content',
    ...
    var AjfReportBuilderCustomWidgetDialog = /** @class */ (function () {
        ...
        AjfReportBuilderCustomWidgetDialog.decorators = [
            { type: core.Component, args: [{selector: 'custom-widget-dialog',
    ...
    var AjfReportBuilderCustomWidgetToolbarButton = /** @class */ (function () {
        ...
        AjfReportBuilderCustomWidgetToolbarButton.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-custom-widget-toolbar-button',
    ...
    var AjfReportBuilderFormsAnalyzerDialog = /** @class */ (function () {
        ...
        function () {
            try {
                monaco.languages.typescript.javascriptDefaults
                    ._extraLibs['condition-editor-functions.d.ts'] = models.AjfValidatedProperty.UTIL_FUNCTIONS;
            }
            catch (e) { }
        };
        /**
        ...
        function () {
            ...
            if (this.formsVariables == null) {
                ...
                return models.AjfFormula.validate(this.formulaText, this.formsVariablesName);
            }
        };
        /**
         * @return {?}
         ...
         */
        function () {
            this._service.saveImageFormula(new models.AjfFormula(this.formulaText));
        };
        /**
         * @return {?}
         */
        ...
        AjfReportBuilderFormsAnalyzerDialog.decorators = [
            { type: core.Component, args: [{selector: 'forms-analyzer-dialog',
    ...
    var AjfReportBuilderFormsAnalyzer = /** @class */ (function () {
        ...
        function (level, mainIndex, index, editMode) {
            ...
            if (editMode) {
                ...
                if (level === 1) {
                    if (this.currentWidget != null &&
                        this.currentWidget.widgetType == reports.AjfReportWidgetType.Chart) {
                        mainIndex++;
                    }
                    index++;
                }
        ...
        AjfReportBuilderFormsAnalyzer.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-forms-analyzer',
    ...
    var AjfReportBuilderImageGroup = /** @class */ (function () {
        ...
        AjfReportBuilderImageGroup.decorators = [
            { type: core.Component, args: [{selector: 'ajf-image-group',
    ...
    var AjfReportBuilderProperties = /** @class */ (function () {
        ...
        function () {
            ...
            function (x) {
                if (x != null) {
                    if (_this.currentWidget !== x) {
                        _this.currentWidget = x;
                        _this.widgetName = reports.AjfReportWidgetType[x.widgetType];
             ...
             * @return {?}
             */
            function (x) { return x != null; })), operators.map((/**
             * @param {?} myObj
             * @return {?}
             */
            function (myObj) {
            ...
            this.getBorderWidthWidgetTop = this.getBorderWidthWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return (/** @type {?} */ (m))[0]; })));
            this.getBorderWidthWidgetRight = this.getBorderWidthWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
            ...
            this.getBorderWidthWidgetBottom = this.getBorderWidthWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
            ...
            this.getBorderWidthWidgetLeft = this.getBorderWidthWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
            ...
            this.getBorderRadiusWidgetTopLeft = this.getBorderRadiusWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[0]; })));
            this.getBorderRadiusWidgetTopRight = this.getBorderRadiusWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[1]; })));
            this.getBorderRadiusWidgetBottomRight = this.getBorderRadiusWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[2]; })));
            this.getBorderRadiusWidgetBottomLeft = this.getBorderRadiusWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
            ...
            this.getMarginWidgetTop = this.getMarginWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[0]; })));
            this.getMarginWidgetRight = this.getMarginWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[1]; })));
            this.getMarginWidgetBottom = this.getMarginWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[2]; })));
            this.getMarginWidgetLeft = this.getMarginWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
            ...
            this.getPaddingWidgetTop = this.getPaddingWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[0]; })));
            this.getPaddingWidgetRight = this.getPaddingWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[1]; })));
            this.getPaddingWidgetBottom = this.getPaddingWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
             ...
             */
            function (m) { return (/** @type {?} */ (m))[2]; })));
            this.getPaddingWidgetLeft = this.getPaddingWidget.pipe(operators.filter((/**
             * @param {?} m
             * @return {?}
             */
            function (m) { return m != null; })), operators.map((/**
        ...
        function (changes) {
            ...
            this.widgetName = reports.AjfReportWidgetType[this.currentWidget.widgetType];
        };
        /**
         * @return {?}
         */
        ...
        AjfReportBuilderProperties.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-properties',
    ...
    var AjfQuillEditor = /** @class */ (function () {
        ...
        AjfQuillEditor.decorators = [
            { type: core.Component, args: [{selector: 'ajf-quill-editor',
    ...
    var AjfReportBuilderRendererWidget = /** @class */ (function () {
        ...
        Object.defineProperty(AjfReportBuilderRendererWidget.prototype, "widgetTypes", {
             ...
             * @return {?}
             */
            function () { return reports.AjfReportWidgetType; },
            enumerable: true,
            configurable: true
        });
        ...
        AjfReportBuilderRendererWidget.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-renderer-widget',
    ...
    var AjfReportBuilderThemeColorDialog = /** @class */ (function () {
        ...
        AjfReportBuilderThemeColorDialog.decorators = [
            { type: core.Component, args: [{selector: 'theme-color-dialog',
    ...
    var AjfReportBuilderThemeColor = /** @class */ (function () {
        ...
        AjfReportBuilderThemeColor.decorators = [
            { type: core.Component, args: [{selector: 'ajf-theme-color',
    ...
    var AjfReportBuilderToolbarDialog = /** @class */ (function () {
        ...
        AjfReportBuilderToolbarDialog.decorators = [
            { type: core.Component, args: [{selector: 'toolbar-dialog',
    ...
    var AjfReportBuilderToolbar = /** @class */ (function () {
        ...
        function () {
            try {
                ...
                this._service.setReport(reports.AjfReport.fromJson(myObj));
            }
            catch (e) { }
        };
        /**
        ...
        AjfReportBuilderToolbar.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-toolbar',
                        outputs: ['addClick'],
    ...
    var AjfReportBuilderWidgetToolbarButton = /** @class */ (function () {
        ...
        AjfReportBuilderWidgetToolbarButton.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-widget-toolbar-button',
                        inputs: ['widgetType'],
    ...
    var AjfReportBuilderWidgetsRowButtons = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            this.label = reports.AjfReportWidgetType[this.widget.widgetType];
        ...
        AjfReportBuilderWidgetsRowButtons.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder-widgets-row-buttons',
    ...
    var AjfReportBuilder = /** @class */ (function () {
        ...
        AjfReportBuilder.decorators = [
            { type: core.Component, args: [{selector: 'ajf-report-builder',

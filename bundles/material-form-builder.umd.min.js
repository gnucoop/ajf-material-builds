...
/*! *****************************************************************************
    ...
    ***************************************************************************** */function I(i,e){var t="function"==typeof Symbol&&i[Symbol.iterator];if(!t)return i;var n,o,r=t.call(i),a=[];try{for(;(void 0===e||e-- >0)&&!(n=r.next()).done;)a.push(n.value)}catch(i){o={error:i}}finally{try{n&&!n.done&&(t=r.return)&&t.call(r)}finally{if(o)throw o.error}}return a}function R(){for(var i=[],e=0;e<arguments.length;e++)i=i.concat(I(arguments[e]));return i}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var k=function(i){function e(){var e=i.call(this)||this;return e._choices=new x.BehaviorSubject([]),e._choicesObs=e._choices.asObservable(),e}return function t(i,e){function t(){this.constructor=i}M(i,e),i.prototype=null===e?Object.create(e):(t.prototype=e.prototype,new t)}(e,i),e.prototype.connect=function(){return this._choicesObs},e.prototype.disconnect=function(){},e.prototype.updateChoices=function(i){this._choices.next(i)},e}(F.DataSource),A=function(){function i(){this._displayedColumns=["label","value","delete"],this.editing={},this._choices=new k,this._choicesArr=[]}return Object.defineProperty(i.prototype,"displayedColumns",{get:function(){return this._displayedColumns},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"choicesOrigin",{get:function(){return this._choicesOrigin},set:function(i){this._choicesOrigin=i,this.name=i.name,this.label=i.label,this.canEditChoices=D.isChoicesFixedOrigin(i),this._choicesArr=i.choices,this._choices.updateChoices(this._choicesArr)},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"choices",{get:function(){return this._choices},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"choicesArr",{get:function(){return this._choicesArr},enumerable:!0,configurable:!0}),i.prototype.updateValue=function(i,e,t,n){this.editing[n+"-"+e]=!1,this._choicesArr[n][e]=i.target.value,this._choices.updateChoices(this._choicesArr)},i.prototype.deleteRow=function(i){this._choicesArr.splice(i,1),this._choices.updateChoices(this._choicesArr)},i.prototype.addRow=function(){this._choicesArr.push({label:"",value:""}),this._choices.updateChoices(this._choicesArr)},i.decorators=[{type:r.Component,args:[{selector:"ajf-fb-choices-origin-editor",template:'<div>\n  <mat-form-field>\n    <input matInput [(ngModel)]="name"\n        [placeholder]="\'Name\' | translate">\n  </mat-form-field>\n  <mat-form-field>\n    <input matInput [(ngModel)]="label"\n        [placeholder]="\'Label\' | translate">\n  </mat-form-field>\n  <ng-template [ngIf]="canEditChoices">\n    <button (click)="addRow()" mat-button>\n      <mat-icon>add</mat-icon>\n      <span translate>Add value</span>\n    </button>\n    <mat-table [dataSource]="choices">\n      <ng-container matColumnDef="label">\n        <mat-header-cell *matHeaderCellDef translate>Label</mat-header-cell>\n        <mat-cell *matCellDef="let row; let idx = index">\n          <input matInput [(ngModel)]="row.label" type="text">\n        </mat-cell>\n      </ng-container>\n      <ng-container matColumnDef="value">\n        <mat-header-cell *matHeaderCellDef translate>Value</mat-header-cell>\n        <mat-cell *matCellDef="let row; let idx = index">\n          <input matInput [(ngModel)]="row.value" type="text">\n        </mat-cell>\n      </ng-container>\n      <ng-container matColumnDef="delete">\n        <mat-header-cell *matHeaderCellDef translate>Delete</mat-header-cell>\n        <mat-cell *matCellDef="let row; let idx = index">\n            <mat-icon (click)="deleteRow(idx)">delete</mat-icon>\n        </mat-cell>\n      </ng-container>\n\n      <mat-header-row *matHeaderRowDef="displayedColumns"></mat-header-row>\n      <mat-row *matRowDef="let row; columns: displayedColumns;"></mat-row>\n    </mat-table>\n  </ng-template>\n</div>\n',encapsulation:r.ViewEncapsulation.None,changeDetection:r.ChangeDetectionStrategy.OnPush,styles:["ajf-fb-choices-origin-editor mat-form-field+mat-form-field{margin-left:1em}ajf-fb-choices-origin-editor mat-table{max-height:300px}ajf-fb-choices-origin-editor mat-table mat-icon{cursor:pointer}\n"]}]}],i.propDecorators={choicesOrigin:[{type:r.Input}]},i}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function B(i,e){if(i.nodes.indexOf(e)>-1)return i;for(var t=i.nodes.filter((function(i){return D.isContainerNode(i)})),n=t.length,o=0;o<n;o++){var r=B(t[o],e);if(null!=r)return r}return null}function L(i,e,t){void 0===t&&(t=!1);var n=i.filter((function(i){return i.parent===e.id})).sort((function(i,e){return i.parentNode-e.parentNode})).map((function(e){var t=L(i,e);return 0===t.length&&t.push({parent:e,parentNode:0}),{node:e,children:t,content:W(0,e)}}));if(!t)for(var o=e.conditionalBranches.length,r=n.length;r<o;r++)n.push({parent:e,parentNode:r});return n}function W(i,e){return D.isContainerNode(e)?L(e.nodes,e,!0):[]}function Y(i){var e=[];return i.forEach((function(i){D.isContainerNode(i)&&(e=e.concat(Y(i.nodes))),e.push(i)})),e}function U(i,e,t){return void 0===t&&(t=null),i.filter(null!=t?function(i){return i.parent===e.id&&i.parentNode===t}:function(i){return i.parent===e.id})}function q(i,e,t){void 0===t&&(t=null);for(var n=Y(i),o=[],r=U(n,e,t),a=r.length,s=0;s<a;s++)o=o.concat(U(n,r[s]));return function i(e,t){for(var n=e.length,o=0;o<n;o++){var r=e[o];D.isContainerNode(r)&&(r.nodes=i(r.nodes,t))}return e.filter((function(i){return-1===t.indexOf(i.id)}))}(i,(o=o.concat(r)).map((function(i){return i.id})))}var z=0,H=function(){function i(){this._availableNodeTypes=[{label:"Slide",icon:{fontSet:"ajf-icon",fontIcon:"field-slide"},nodeType:{node:D.AjfNodeType.AjfSlide},isSlide:!0},{label:"Repeating slide",icon:{fontSet:"ajf-icon",fontIcon:"field-repeatingslide"},nodeType:{node:D.AjfNodeType.AjfRepeatingSlide},isSlide:!0},{label:"String",icon:{fontSet:"ajf-icon",fontIcon:"field-string"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.String}},{label:"Text",icon:{fontSet:"ajf-icon",fontIcon:"field-text"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Text}},{label:"Number",icon:{fontSet:"ajf-icon",fontIcon:"field-number"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Number}},{label:"Boolean",icon:{fontSet:"ajf-icon",fontIcon:"field-boolean"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Boolean}},{label:"Single choice",icon:{fontSet:"ajf-icon",fontIcon:"field-singlechoice"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.SingleChoice}},{label:"Multiple choice",icon:{fontSet:"ajf-icon",fontIcon:"field-multiplechoice"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.MultipleChoice}},{label:"Formula",icon:{fontSet:"ajf-icon",fontIcon:"field-formula"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Formula}},{label:"Date",icon:{fontSet:"ajf-icon",fontIcon:"field-date"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Date}},{label:"Date input",icon:{fontSet:"ajf-icon",fontIcon:"field-dateinput"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.DateInput}},{label:"Time",icon:{fontSet:"ajf-icon",fontIcon:"field-time"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Time}},{label:"Table",icon:{fontSet:"ajf-icon",fontIcon:"field-table"},nodeType:{node:D.AjfNodeType.AjfField,field:D.AjfFieldType.Table}}],this._form=new x.BehaviorSubject(null),this._formObs=this._form.asObservable(),this._editedNodeEntry=new x.BehaviorSubject(null),this._editedNodeEntryObs=this._editedNodeEntry.asObservable(),this._editedCondition=new x.BehaviorSubject(null),this._editedConditionObs=this._editedCondition.asObservable(),this._editedChoicesOrigin=new x.BehaviorSubject(null),this._editedChoicesOriginObs=this._editedChoicesOrigin.asObservable(),this._beforeNodesUpdate=new r.EventEmitter,this._beforeNodesUpdateObs=this._beforeNodesUpdate.asObservable(),this._afterNodeUpdate=new r.EventEmitter,this._afterNodeUpdateObs=this._afterNodeUpdate.asObservable(),this._nodesUpdates=new x.Subject,this._attachmentsOriginsUpdates=new x.Subject,this._choicesOriginsUpdates=new x.Subject,this._stringIdentifierUpdates=new x.Subject,this._saveNodeEntryEvent=new r.EventEmitter,this._deleteNodeEntryEvent=new r.EventEmitter,this._initChoicesOriginsStreams(),this._initAttachmentsOriginsStreams(),this._initStringIdentifierStreams(),this._initNodesStreams(),this._initFormStreams(),this._initSaveNode(),this._initDeleteNode()}return Object.defineProperty(i.prototype,"availableNodeTypes",{get:function(){return this._availableNodeTypes},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"form",{get:function(){return this._formObs},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"attachmentsOrigins",{get:function(){return this._attachmentsOrigins},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"choicesOrigins",{get:function(){return this._choicesOrigins},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"stringIdentifier",{get:function(){return this._stringIdentifier},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"nodes",{get:function(){return this._nodes},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"flatNodes",{get:function(){return this._flatNodes},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"flatFields",{get:function(){return this._flatFields},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"nodeEntriesTree",{get:function(){return this._nodeEntriesTree},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"editedNodeEntry",{get:function(){return this._editedNodeEntryObs},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"editedCondition",{get:function(){return this._editedConditionObs},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"editedChoicesOrigin",{get:function(){return this._editedChoicesOriginObs},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"beforeNodesUpdate",{get:function(){return this._beforeNodesUpdateObs},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"afterNodeUpdate",{get:function(){return this._afterNodeUpdateObs},enumerable:!0,configurable:!0}),i.prototype.setForm=function(i){i!==this._form.getValue()&&this._form.next(i)},i.prototype.editNodeEntry=function(i){this._editedNodeEntry.next(i)},i.prototype.editCondition=function(i){this._editedCondition.next(i)},i.prototype.saveCurrentCondition=function(i){var e=this._editedCondition.getValue();null!=e&&(e.condition=i,this._editedCondition.next(null))},i.prototype.cancelConditionEdit=function(){this._editedChoicesOrigin.next(null)},i.prototype.insertNode=function(i,e,t,n){var o;void 0===n&&(n=!1);var r=++z,a=null!=i.nodeType.field;o=a?D.createField({id:r,nodeType:D.AjfNodeType.AjfField,fieldType:i.nodeType.field,parent:e.id,parentNode:t,name:""}):D.createContainerNode({id:r,nodeType:i.nodeType.node,parent:null!=e?e.id:0,parentNode:t,name:"",nodes:[]}),this._beforeNodesUpdate.emit(),this._nodesUpdates.next((function(i){if(0===o.parent)return[o];var t=D.isContainerNode(e)&&n?e:B({nodes:i},e);if(null!=t)if(a)t.nodes.push(o);else{var r=t.nodes===i,s=t.nodes.slice(0);s.push(o),t.nodes=s,r&&(i=s)}return i}))},i.prototype.saveNodeEntry=function(i){this._saveNodeEntryEvent.emit(i)},i.prototype.cancelNodeEntryEdit=function(){this._editedNodeEntry.next(null)},i.prototype.deleteNodeEntry=function(i){this._deleteNodeEntryEvent.next(i)},i.prototype.getCurrentForm=function(){return x.combineLatest([this.form,this.nodes,this.attachmentsOrigins,this.choicesOrigins,this.stringIdentifier]).pipe(O.filter((function(i){return null!=I(i,1)[0]})),O.map((function(i){var e=I(i,5),t=e[0],n=e[1],o=e[2],r=e[4];return D.createForm({choicesOrigins:e[3].slice(0),attachmentsOrigins:o.slice(0),stringIdentifier:(r||[]).slice(0),nodes:n.slice(0),supplementaryInformations:t.supplementaryInformations})})))},i.prototype.editChoicesOrigin=function(i){this._editedChoicesOrigin.next(i)},i.prototype.createChoicesOrigin=function(){this._editedChoicesOrigin.next(D.createChoicesFixedOrigin({name:""}))},i.prototype.cancelChoicesOriginEdit=function(){this._editedChoicesOrigin.next(null)},i.prototype.saveChoicesOrigin=function(i){var e=this._editedChoicesOrigin.getValue();null!=e&&(e.label=i.label,e.name=i.name,D.isChoicesFixedOrigin(e)&&(e.choices=i.choices),this._choicesOriginsUpdates.next((function(i){var t=i.indexOf(e);return t>-1?R(i.slice(0,t),[e],i.slice(t+1)):R(i,[e])}))),this._editedChoicesOrigin.next(null)},i.prototype.saveStringIdentifier=function(i){this._stringIdentifierUpdates.next((function(){return R(i)}))},i.prototype._findMaxNodeId=function(i,e){var t=this;void 0===e&&(e=0);var n=0;return i.forEach((function(i){n=Math.max(n,i.id),D.isContainerNode(i)&&(n=Math.max(n,t._findMaxNodeId(i.nodes)))})),n},i.prototype._initFormStreams=function(){var i=this;this._form.subscribe((function(e){z=0,null!=e&&null!=e.nodes&&e.nodes.length>0&&(z=i._findMaxNodeId(e.nodes)),i._nodesUpdates.next((function(i){return null!=e&&null!=e.nodes?e.nodes.slice(0):[]})),i._attachmentsOriginsUpdates.next((function(i){return null!=e&&null!=e.attachmentsOrigins?e.attachmentsOrigins.slice(0):[]})),i._choicesOriginsUpdates.next((function(i){return null!=e&&null!=e.choicesOrigins?e.choicesOrigins.slice(0):[]})),i._stringIdentifierUpdates.next((function(i){return null!=e&&null!=e.stringIdentifier?e.stringIdentifier.slice(0):[]}))}))},i.prototype._initChoicesOriginsStreams=function(){this._choicesOrigins=this._choicesOriginsUpdates.pipe(O.scan((function(i,e){return e(i)}),[]),O.publishReplay(1),O.refCount())},i.prototype._initAttachmentsOriginsStreams=function(){this._attachmentsOrigins=this._attachmentsOriginsUpdates.pipe(O.scan((function(i,e){return e(i)}),[]),O.publishReplay(1),O.refCount())},i.prototype._initStringIdentifierStreams=function(){this._stringIdentifier=this._stringIdentifierUpdates.pipe(O.scan((function(i,e){return e(i)}),[]),O.publishReplay(1),O.refCount())},i.prototype._initNodesStreams=function(){this._nodes=this._nodesUpdates.pipe(O.scan((function(i,e){return e(i)}),[]),O.publishReplay(1),O.refCount()),this._flatNodes=this._nodes.pipe(O.map((function(i){return Y(i)})),O.publishReplay(1),O.refCount()),this._flatFields=this._flatNodes.pipe(O.map((function(i){return i.filter((function(i){return!D.isContainerNode(i)}))})),O.publishReplay(1),O.refCount()),this._nodeEntriesTree=this._nodes.pipe(O.map((function(i){return function e(i){var e=i.filter((function(i){return null==i.parent||0===i.parent}));if(1===e.length){var t=e[0];if(D.isSlidesNode(t)){var n=[];return n.push({node:t,container:null,children:L(i,t),content:W(0,t)}),n}}else if(0===e.length)return[null];throw new Error("Invalid form definition")}(i)})),O.publishReplay(1),O.refCount())},i.prototype._initSaveNode=function(){var i=this;this._saveNodeEntryEvent.pipe(O.withLatestFrom(this.editedNodeEntry,this.choicesOrigins,this.attachmentsOrigins),O.filter((function(i){return null!=I(i,2)[1]})),O.map((function(e){var t=I(e,2),n=t[0],o=t[1];i._beforeNodesUpdate.emit();var r=(o=o).node,a=N.deepCopy(r);a.id=o.node.id,a.name=n.name,a.label=n.label,a.visibility=null!=n.visibility?w.createCondition({condition:n.visibility}):null;var s=a.conditionalBranches.length;a.conditionalBranches=null!=n.conditionalBranches?n.conditionalBranches.map((function(i){return w.createCondition({condition:i})})):[w.alwaysCondition()];var l=a.conditionalBranches.length;if(D.isRepeatingContainerNode(a)){var d=a;d.formulaReps=null!=n.formulaReps?w.createFormula({formula:n.formulaReps}):void 0,d.minReps=n.minReps,d.maxReps=n.maxReps}if(D.isField(a)){var c=a;c.description=n.description,c.defaultValue=n.defaultValue,c.formula=null!=n.formula?w.createFormula({formula:n.formula}):void 0;var u=n.value,p=n.notEmpty,f=n.validationConditions,h=parseInt(n.minValue,10),m=parseInt(n.maxValue,10),g=parseInt(n.minDigits,10),b=parseInt(n.maxDigits,10);if(isNaN(h)&&(h=null),isNaN(m)&&(m=null),isNaN(g)&&(g=null),isNaN(b)&&(b=null),null!=u||null!=p||null!=f&&f.length>0||null!=h||null!=m||null!=g||null!=b){var _=c.validation||D.createValidationGroup({});_.forceValue=u,_.notEmpty=p?D.notEmptyValidation():void 0,_.minValue=null!=h?D.minValidation(h):void 0,_.maxValue=null!=m?D.maxValidation(m):void 0,_.minDigits=null!=g?D.minDigitsValidation(g):void 0,_.maxDigits=null!=b?D.maxDigitsValidation(b):void 0,_.conditions=(f||[]).map((function(i){return D.createValidation({condition:i.condition,errorMessage:i.errorMessage})})),c.validation=_}else c.validation=void 0;var v=n.notEmptyWarning,y=n.warningConditions;if(null!=v||null!=y&&y.length>0){var C=c.warning||D.createWarningGroup({});C.notEmpty=v?D.notEmptyWarning():void 0,C.conditions=(y||[]).map((function(i){return D.createWarning({condition:i.condition,warningMessage:i.warningMessage})})),c.warning=C}else c.warning=void 0;if(c.nextSlideCondition=null!=n.nextSlideCondition?w.createCondition({condition:n.nextSlideCondition}):void 0,c.size=n.size,c.defaultValue=n.defaultValue,D.isFieldWithChoices(c)){var j=c;j.choicesOriginRef=n.choicesOriginRef,j.forceExpanded=n.forceExpanded,j.forceNarrow=n.forceNarrow,j.triggerConditions=(n.triggerConditions||[]).map((function(i){return w.createCondition({condition:i})}))}}return i._editedNodeEntry.next(null),function(i){var e=B({nodes:i},r);if(null!=e){var t=e.nodes===i,n=e.nodes.indexOf(r),o=e.nodes.slice(0,n);if(o.push(a),o=o.concat(e.nodes.slice(n+1)),e.nodes=o,i=t?o:i.slice(0),l<s)for(var d=l;d<s;d++)i=q(i,a,d)}return i}}))).subscribe(this._nodesUpdates)},i.prototype._initDeleteNode=function(){var i=this;this._deleteNodeEntryEvent.pipe(O.map((function(e){return i._beforeNodesUpdate.emit(),function(i){var t=e.node,n=B({nodes:i},t);if(null!=n){var o=n.nodes===i,r=n.nodes.indexOf(t),a=n.nodes.slice(0,r);a=a.concat(n.nodes.slice(r+1)),n.nodes=a,i=q(i=o?a:i.slice(0),t)}return i}}))).subscribe(this._nodesUpdates)},i.decorators=[{type:r.Injectable}],i.ctorParameters=function(){return[]},i}(),$=function(){function i(i){this._service=i,this._choicesOrigin=this._service.editedChoicesOrigin.pipe(O.filter((function(i){return null!=i})),O.map((function(i){return i})))}return Object.defineProperty(i.prototype,"choicesOrigin",{get:function(){return this._choicesOrigin},enumerable:!0,configurable:!0}),i.prototype.saveChoicesOrigin=function(){this._service.saveChoicesOrigin({label:this.editor.label,name:this.editor.name,choices:this.editor.choicesArr})},i.prototype.cancelChoicesOriginEdit=function(){this._service.cancelChoicesOriginEdit()},i.decorators=[{type:r.Component,args:[{selector:"ajf-fb-choices-origin-editor-dialog",template:'<h3 matDialogTitle translate>Edit choices origin</h3>\n<mat-dialog-content>\n  <ajf-fb-choices-origin-editor\n      *ngIf="choicesOrigin|async as co"\n      [choicesOrigin]="co!"></ajf-fb-choices-origin-editor>\n</mat-dialog-content>\n<mat-dialog-actions>\n  <button mat-button translate (click)="saveChoicesOrigin()">Save</button>\n  <button mat-button translate (click)="cancelChoicesOriginEdit()">Close</button>\n</mat-dialog-actions>\n',encapsulation:r.ViewEncapsulation.None,changeDetection:r.ChangeDetectionStrategy.OnPush,styles:["\n"]}]}],i.ctorParameters=function(){return[{type:H}]},i.propDecorators={editor:[{type:r.ViewChild,args:[A,{static:!1}]}]},i}(),J=function(){function i(i){}return Object.defineProperty(i.prototype,"fields",{get:function(){return this._fields},set:function(i){this._fields=i,this._updateVariables()},enumerable:!0,configurable:!0}),i.prototype.insertVariable=function(i){if(null!=this.monacoEditor&&null!=this.monacoEditor.editor){var e=this.monacoEditor.editor,t=e.getValue().split("\n"),n=e.getPosition(),o=n.lineNumber-1,r=t[o],a=n.column-1;r=r.substring(0,a)+i+r.substring(a),t[o]=r,n.column+=i.length,this.monacoEditor.value=t.join("\n"),e.setPosition(n),e.focus(),this.editedValue=e.getValue()}},i.prototype.onEditorInit=function(){monaco.languages.typescript.javascriptDefaults.setDiagnosticsOptions({noSemanticValidation:!1,noSyntaxValidation:!1}),monaco.languages.typescript.javascriptDefaults.setCompilerOptions({target:monaco.languages.typescript.ScriptTarget.ES2015,allowNonTsExtensions:!0,allowJs:!0,module:monaco.languages.typescript.ModuleKind.None});try{monaco.languages.typescript.javascriptDefaults.addExtraLib("","condition-editor-variables.d.ts")}catch(i){monaco.languages.typescript.javascriptDefaults._extraLibs["condition-editor-variables.d.ts"]=""}try{monaco.languages.typescript.javascriptDefaults.addExtraLib("","condition-editor-functions.d.ts")}catch(i){monaco.languages.typescript.javascriptDefaults._extraLibs["condition-editor-functions.d.ts"]=""}this._updateVariables(),this._updateFunctions()},i.prototype._updateVariables=function(){var i=this;if(null!=this._fields)try{monaco.languages.typescript.javascriptDefaults._extraLibs["condition-editor-variables.d.ts"]=this._fields.map((function(e){return"declare const "+e.name+": "+i._fieldVarType(e.fieldType)+";"})).join("\n")}catch(i){}},i.prototype._updateFunctions=function(){try{monaco.languages.typescript.javascriptDefaults._extraLibs["condition-editor-functions.d.ts"]=w.AjfExpressionUtils.UTIL_FUNCTIONS}catch(i){}},i.prototype._fieldVarType=function(i){switch(i){case D.AjfFieldType.Boolean:return"boolean";case D.AjfFieldType.Date:case D.AjfFieldType.DateInput:case D.AjfFieldType.Time:return"Date";case D.AjfFieldType.Empty:return"void";case D.AjfFieldType.Formula:return"number";case D.AjfFieldType.MultipleChoice:case D.AjfFieldType.SingleChoice:return"any";case D.AjfFieldType.Number:return"number";case D.AjfFieldType.Table:return"Array";case D.AjfFieldType.String:case D.AjfFieldType.Text:return"string"}return null},i.decorators=[{type:r.Component,args:[{selector:"ajf-condition-editor",template:'<div class="ajf-editor">\n  <ajf-monaco-editor\n      (init)="onEditorInit()"\n      (valueChange)="editedValue = $event"\n      [value]="condition" language="javascript"></ajf-monaco-editor>\n</div>\n<div class="ajf-editor-panel">\n  <ng-container *ngIf="fields as curFields">\n    <mat-nav-list dense *ngIf="curFields!.length > 0">\n      <a mat-list-item\n          (click)="insertVariable(field.name)"\n          [matTooltip]="field.label"\n          *ngFor="let field of curFields!">\n        <ajf-node-icon [node]="field"></ajf-node-icon>\n        {{ field.name }}\n      </a>\n    </mat-nav-list>\n  </ng-container>\n</div>\n',changeDetection:r.ChangeDetectionStrategy.OnPush,encapsulation:r.ViewEncapsulation.None,styles:["ajf-condition-editor{display:flex;flex-direction:row;align-items:stretch;max-height:512px}ajf-condition-editor .ajf-editor{flex:.75 0 auto;display:flex;flex-direction:row;align-items:stretch}ajf-condition-editor .ajf-editor monaco-editor{flex:1 0 auto;min-width:512px;min-height:256px}ajf-condition-editor .ajf-editor-panel{flex:.25 0 auto;overflow-y:auto}ajf-condition-editor ajf-monaco-editor{min-width:400px}\n"]}]}],i.ctorParameters=function(){return[{type:D.AjfValidationService}]},i.propDecorators={monacoEditor:[{type:r.ViewChild,args:[e.AjfMonacoEditor,{static:!0}]}],fields:[{type:r.Input}],condition:[{type:r.Input}]},i}(),Z=function(){function i(i,e){this.dialogRef=e,this._fields=i.flatFields.pipe(O.map((function(i){return i.sort((function(i,e){return i.name.localeCompare(e.name)}))})))}return Object.defineProperty(i.prototype,"fields",{get:function(){return this._fields},enumerable:!0,configurable:!0}),i.prototype.saveCondition=function(){null!=this.editor&&this.dialogRef.close(this.editor.editedValue)},i.decorators=[{type:r.Component,args:[{selector:"ajf-condition-editor-dialog",template:'<h3 matDialogTitle translate>Edit condition</h3>\n<mat-dialog-content>\n  <ajf-condition-editor\n      *ngIf="fields|async as curFields"\n      [fields]="curFields!"\n      [condition]="condition"></ajf-condition-editor>\n</mat-dialog-content>\n<mat-dialog-actions>\n  <button mat-button translate (click)="saveCondition()">Save</button>\n  <button mat-button translate matDialogClose>Close</button>\n</mat-dialog-actions>\n',encapsulation:r.ViewEncapsulation.None,changeDetection:r.ChangeDetectionStrategy.OnPush,styles:["ajf-condition-editor-dialog mat-dialog-content{overflow:visible}\n"]}]}],i.ctorParameters=function(){return[{type:H},{type:p.MatDialogRef}]},i.propDecorators={editor:[{type:r.ViewChild,args:[J,{static:!1}]}]},i}(),G=function(){function i(i,e){var t=this;this._service=i,this._cdr=e,this.dataSource=new C.MatTableDataSource,this.displayedColumns=["label","value","delete"],this.separatorKeysCodes=[T.ENTER,T.COMMA],this._stringIdentifierSub=x.Subscription.EMPTY,this._stringIdentifierSub=i.stringIdentifier.subscribe((function(i){t.dataSource.data=R(i)})),this.fields$=i.flatFields.pipe(O.map((function(i){return i.sort((function(i,e){return i.name.localeCompare(e.name)})).map((function(i){return i.name})).filter((function(i){return i.length>0}))})),O.shareReplay(1))}return i.prototype.addRow=function(){this.dataSource.data=R(this.dataSource.data,[{label:"",value:[]}])},i.prototype.deleteRow=function(i){this.dataSource.data=R(this.dataSource.data.slice(0,i),this.dataSource.data.slice(i+1))},i.prototype.addValue=function(i,e,t){0!==e.value.length&&(i.value=R(i.value,[e.value]),t.value="",this._cdr.markForCheck())},i.prototype.removeValue=function(i,e){var t=i.value.indexOf(e);t>-1&&(i.value=R(i.value.slice(0,t),i.value.slice(t+1)),this._cdr.markForCheck())},i.prototype.ngOnDestroy=function(){this._stringIdentifierSub.unsubscribe()},i.prototype.saveStringIdentifier=function(){this._service.saveStringIdentifier(this.dataSource.data)},i.prototype.selected=function(i,e){i.value=R(i.value,[e.option.value]),this._cdr.markForCheck()},i.decorators=[{type:r.Component,args:[{selector:"ajf-fb-string-identifier-dialog",template:'<h3 matDialogTitle translate>Edit identifier</h3>\n<mat-dialog-content>\n  <button (click)="addRow()" mat-button>\n    <mat-icon>add</mat-icon>\n    <span translate>Add value</span>\n  </button>\n  <mat-table [dataSource]="dataSource">\n    <ng-container matColumnDef="label">\n      <mat-header-cell *matHeaderCellDef translate>Label</mat-header-cell>\n      <mat-cell *matCellDef="let row; let idx = index">\n        <mat-form-field>\n          <input matInput [placeholder]="\'Label\'|translate" autofocus [(ngModel)]="row.label">\n        </mat-form-field>\n      </mat-cell>\n    </ng-container>\n    <ng-container matColumnDef="value">\n      <mat-header-cell *matHeaderCellDef translate>Value</mat-header-cell>\n      <mat-cell *matCellDef="let row; let idx = index">\n        <mat-form-field>\n          <mat-chip-list #chipList>\n            <mat-chip\n                *ngFor="let field of row.value"\n                (removed)="removeValue(row, field)"\n            >\n              {{ field }}\n              <mat-icon matChipRemove>cancel</mat-icon>\n            </mat-chip>\n          </mat-chip-list>\n          <input\n              #valueInput\n              [ngModel]="row.value"\n              [matAutocomplete]="valueAc"\n              [matChipInputFor]="chipList"\n              [matChipInputSeparatorKeyCodes]="separatorKeysCodes"\n              [matChipInputAddOnBlur]="true"\n              (matChipInputTokenEnd)="addValue(row, $event, valueInput)"\n              [placeholder]="\'Value\'|translate">\n          <mat-autocomplete #valueAc="matAutocomplete"\n              (optionSelected)="selected(row, $event)">\n            <mat-option *ngFor="let field of fields$ | async" [value]="field">{{field}}</mat-option>\n          </mat-autocomplete>\n        </mat-form-field>\n      </mat-cell>\n    </ng-container>\n    <ng-container matColumnDef="delete">\n      <mat-header-cell *matHeaderCellDef translate>Delete</mat-header-cell>\n      <mat-cell *matCellDef="let row; let idx = index">\n          <mat-icon (click)="deleteRow(idx)">delete</mat-icon>\n      </mat-cell>\n    </ng-container>\n\n    <mat-header-row *matHeaderRowDef="displayedColumns"></mat-header-row>\n    <mat-row *matRowDef="let row; columns: displayedColumns;"></mat-row>\n  </mat-table>\n</mat-dialog-content>\n<mat-dialog-actions>\n  <button mat-button translate matDialogClose (click)="saveStringIdentifier()">Save</button>\n</mat-dialog-actions>\n',changeDetection:r.ChangeDetectionStrategy.OnPush,encapsulation:r.ViewEncapsulation.None,styles:["\n"]}]}],i.ctorParameters=function(){return[{type:H},{type:r.ChangeDetectorRef}]},i}(),K=function(){function i(i,e){var t=this;this._service=i,this._dialog=e,this._vc=new r.EventEmitter,this._init=!1,this._editConditionSub=x.Subscription.EMPTY,this._beforeNodesUpdateSub=x.Subscription.EMPTY,this._editChoicesOriginSub=x.Subscription.EMPTY,this._stringIdentifierSub=x.Subscription.EMPTY,this._nodeTypes=i.availableNodeTypes,this._nodeEntriesTree=i.nodeEntriesTree,this._choicesOrigins=i.choicesOrigins,this._editConditionSub=this._service.editedCondition.subscribe((function(i){null!=t._editConditionDialog&&(t._editConditionDialog.close(),t._editConditionDialog=null),null!=i&&(t._editConditionDialog=t._dialog.open(Z,{disableClose:!0}))})),this._editChoicesOriginSub=this._service.editedChoicesOrigin.subscribe((function(i){null!=t._editChoicesOriginDialog&&(t._editChoicesOriginDialog.close(),t._editChoicesOriginDialog=null),null!=i&&(t._editChoicesOriginDialog=t._dialog.open($,{disableClose:!0}))})),this._beforeNodesUpdateSub=this._service.beforeNodesUpdate.subscribe((function(){null!=t.designerCont&&(t._lastScrollTop=t.designerCont.nativeElement.scrollTop)})),this.nodeEntriesTree.pipe(O.sample(this._vc)).subscribe((function(){null!=t.designerCont&&(t.designerCont.nativeElement.scrollTop=t._lastScrollTop)})),this._stringIdentifierSub=this._service.stringIdentifier.subscribe((function(){}))}return Object.defineProperty(i.prototype,"form",{get:function(){return this._form},set:function(i){this._form!==i&&(this._form=i,this._init&&this._setCurrentForm())},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"nodeTypes",{get:function(){return this._nodeTypes},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"nodeEntriesTree",{get:function(){return this._nodeEntriesTree},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"choicesOrigins",{get:function(){return this._choicesOrigins},enumerable:!0,configurable:!0}),i.prototype.ngAfterViewChecked=function(){this._vc.emit()},i.prototype.ngAfterContentInit=function(){this._setCurrentForm(),this._init=!0},i.prototype.ngOnDestroy=function(){this._editConditionSub.unsubscribe(),this._beforeNodesUpdateSub.unsubscribe(),this._editChoicesOriginSub.unsubscribe(),this._stringIdentifierSub.unsubscribe(),this._service.setForm(null)},i.prototype.createChoicesOrigin=function(){this._service.createChoicesOrigin()},i.prototype.disableDropPredicate=function(){return!1},i.prototype.editChoicesOrigin=function(i){this._service.editChoicesOrigin(i)},i.prototype.editStringIdentifier=function(){null!=this._stringIdentifierDialog&&(this._stringIdentifierDialog.close(),this._stringIdentifierDialog=null),this._stringIdentifierDialog=this._dialog.open(G,{disableClose:!0,width:"60%",height:"60%"})},i.prototype._setCurrentForm=function(){this._service.setForm(this._form)},i.decorators=[{type:r.Component,args:[{selector:"ajf-form-builder",template:'<mat-toolbar>\n  <button mat-icon-button (click)="leftSidenav.toggle()">\n    <mat-icon>add_box</mat-icon>\n  </button>\n  <button mat-button [matMenuTriggerFor]="choicesMenu" translate>Choices</button>\n  <button mat-button (click)="editStringIdentifier()" translate>Identifier</button>\n  <mat-menu #choicesMenu>\n    <button (click)="createChoicesOrigin()" mat-menu-item translate>New..</button>\n    <ng-container *ngIf="choicesOrigins|async as cos">\n      <button *ngFor="let choicesOrigin of cos"\n          (click)="editChoicesOrigin(choicesOrigin)" mat-menu-item>\n        {{ choicesOrigin.label || choicesOrigin.name }}\n      </button>\n    </ng-container>\n  </mat-menu>\n  <span class="ajf-spacer"></span>\n  <button mat-icon-button (click)="rightSidenav.toggle()">\n    <mat-icon>settings</mat-icon>\n  </button>\n</mat-toolbar>\n<mat-drawer-container cdkDropListGroup>\n  <mat-drawer #leftSidenav position="start" mode="over">\n    <div #sourceDropList cdkDropList\n        [cdkDropListEnterPredicate]="disableDropPredicate"\n        [cdkDropListData]="nodeTypes">\n      <ajf-fb-node-type-entry *ngFor="let nodeType of nodeTypes"\n          cdkDrag\n          [cdkDragData]="nodeType"\n          (cdkDragStarted)="leftSidenav.close()"\n          [nodeType]="nodeType"></ajf-fb-node-type-entry>\n    </div>\n  </mat-drawer>\n  <mat-drawer #rightSidenav position="end" mode="side" [opened]="true">\n    <ajf-fb-node-properties></ajf-fb-node-properties>\n  </mat-drawer>\n  <div #designer class="ajf-designer">\n    <ajf-fb-node-entry\n        *ngFor="let nodeEntry of (nodeEntriesTree|async); let isFirst = first"\n        [isFirst]="isFirst"\n        [nodeEntry]="nodeEntry"></ajf-fb-node-entry>\n  </div>\n</mat-drawer-container>\n',changeDetection:r.ChangeDetectionStrategy.OnPush,encapsulation:r.ViewEncapsulation.None,styles:["ajf-form-builder{display:flex;position:relative;min-height:300px;flex-direction:column;align-items:stretch}ajf-form-builder mat-toolbar mat-menu div[mat-menu-item]>button[mat-button]{flex:1 0 auto}ajf-form-builder mat-toolbar mat-menu div[mat-menu-item]>button[mat-icon-button]{flex:0 0 auto}ajf-form-builder mat-drawer-container{flex:1}ajf-form-builder mat-drawer-container mat-drawer{max-width:20%}ajf-form-builder mat-drawer-container .ajf-designer{padding:1em}ajf-form-builder mat-toolbar .ajf-spacer{flex:1 1 auto}\n"]}]}],i.ctorParameters=function(){return[{type:H},{type:p.MatDialog}]},i.propDecorators={designerCont:[{type:r.ViewChild,args:["designer",{static:!0}]}],form:[{type:r.Input}]},i}(),Q=["#F44336","#4CAF50","#3F51B5","#FFC107","#795548"],X=function(){function i(i){this._service=i,this._hasContent=!1,this._isFirst=!1,this._isNodeEntry=!1,this._level=0,this._branchColors=Q.slice(0),this._dropZones=["fbdz-node"],this._slideDropZones=["fbdz-slide"],this._originOffset=0,this._originLeftMargin="0",this._firstBranchColor=Q[0],this._branchLinesSubscription=x.Subscription.EMPTY,this._childEntriesSubscription=x.Subscription.EMPTY,this._currentEditedNode=this._service.editedNodeEntry}return Object.defineProperty(i.prototype,"hasContent",{get:function(){return this._hasContent},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"isFirst",{get:function(){return this._isFirst},set:function(i){this._isFirst=i},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"isNodeEntry",{get:function(){return this._isNodeEntry},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"nodeEntry",{get:function(){return this._nodeEntry},set:function(i){if(this._nodeEntry=i,null!=i&&void 0!==i.node){var e=i;this._isNodeEntry=!0;var t=e.node;this._hasContent=null!=t&&D.isContainerNode(t)}else this._isNodeEntry=!1,this._hasContent=!1},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"level",{get:function(){return this._level},set:function(i){this._level=i},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"realNodeEntry",{get:function(){return this._nodeEntry},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"branchColors",{get:function(){return this._branchColors},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"dropZones",{get:function(){return this._dropZones},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"slideDropZones",{get:function(){return this._slideDropZones},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"originOffset",{get:function(){return this._originOffset},set:function(i){this._originOffset=i,this._originLeftMargin=4*this._originOffset+"px"},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"originLeftMargin",{get:function(){return this._originLeftMargin},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"firstBranchColor",{get:function(){return this._firstBranchColor},set:function(i){var e=Q.indexOf(i);e>0?(this._firstBranchColor=i,this._branchColors=Q.slice(e).concat(Q.slice(0,e))):(this._firstBranchColor=Q[0],this._branchColors=Q.slice(0))},enumerable:!0,configurable:!0}),Object.defineProperty(i.prototype,"currentEditedNode",{get:function(){return this._currentEditedNode},enumerable:!0,configurable:!0}),i.prototype.onResize=function(){},i.prototype.edit=function(){null!=this.nodeEntry&&this.isNodeEntry&&this._service.editNodeEntry(this.nodeEntry)},i.prototype.delete=function(){null!=this.nodeEntry&&this.isNodeEntry&&this._service.deleteNodeEntry(this.nodeEntry)},i.prototype.ngAfterViewInit=function(){var i=this;setTimeout((function(){return i._updateBranchHeights()})),this._childEntriesSubscription=this.childEntries.changes.subscribe((function(){i._updateBranchHeights()}))},i.prototype.ngOnDestroy=function(){this._branchLinesSubscription.unsubscribe(),this._childEntriesSubscription.unsubscribe()},i.prototype.onDropSuccess=function(i,e){void 0===e&&(e=!1);var t=i.item.data;if(null!=this._nodeEntry){if(void 0!==t.nodeType&&(!this.isNodeEntry||this.isNodeEntry&&e)){var n=e?{parent:this.nodeEntry.node,parentNode:0}:this._nodeEntry;this._service.insertNode(t,n.parent,n.parentNode,e)}}else this._service.insertNode(t,null,0,e)},i.prototype.disableSlideDropPredicate=function(i){return!i.data.isSlide},i.prototype.emptyAreaDropPredicate=function(){var i=this;return function(e,t){return i._level>0?!e.data.isSlide:e.data.isSlide||!1}},i.prototype._updateBranchHeights=function(){if(null!=this.nodeEntry&&this.isNodeEntry&&null!=this.branchLines&&null!=this.childEntries){var i=this.nodeEntry,e=this.branchLines.toArray(),t=null!=i.content?i.content.length:0,n=this.childEntries.toArray().slice(t);e.length==n.length&&e.forEach((function(i,e){i.height=n[e].nativeElement.offsetTop}))}},i.decorators=[{type:r.Component,args:[{selector:"ajf-fb-node-entry",template:'<ng-container *ngIf="nodeEntry != null ; else rootEmpty">\n  <ng-template [ngIf]="isNodeEntry">\n    <ajf-fb-branch-line\n        *ngFor="let childNodeEntry of realNodeEntry.children; let idx = index"\n        [offset]="idx"\n        [color]="branchColors[idx]"></ajf-fb-branch-line>\n  </ng-template>\n  <div class="mat-card-container"\n      [class.ajf-highlight]="(currentEditedNode|async) == nodeEntry">\n    <div *ngIf="!isFirst"\n        class="ajf-origin-line"\n        [style.margin-left]="originLeftMargin"\n        [style.border-color]="firstBranchColor"></div>\n    <ng-template [ngIf]="isNodeEntry">\n      <mat-card>\n        <div class="ajf-title-row">\n          <ajf-node-icon [node]="realNodeEntry.node"></ajf-node-icon>\n          <span class="ajf-title" [innerHTML]="(realNodeEntry.node.label || realNodeEntry.node.name)  | translate"></span>\n          <span class="ajf-actions">\n            <button [disabled]="(currentEditedNode|async) == nodeEntry" (click)="edit()" mat-icon-button>\n              <mat-icon>edit</mat-icon>\n            </button>\n            <button [disabled]="(currentEditedNode|async) == null" (click)="delete()" mat-icon-button>\n              <mat-icon>delete</mat-icon>\n            </button>\n          </span>\n        </div>\n        <div *ngIf="hasContent">\n          <ajf-fb-node-entry\n              *ngFor="let contentEntry of realNodeEntry.content; let isFirstChild = first; let idx = index"\n              [level]="level + 1"\n              [isFirst]="isFirstChild"\n              [firstBranchColor]="branchColors[idx]"\n              [nodeEntry]="contentEntry"></ajf-fb-node-entry>\n          <mat-card class="ajf-empty"\n              *ngIf="realNodeEntry.content.length === 0"\n              cdkDropList\n              [cdkDropListEnterPredicate]="disableSlideDropPredicate"\n              (cdkDropListDropped)="onDropSuccess($event, true)">&nbsp;</mat-card>\n        </div>\n      </mat-card>\n    </ng-template>\n    <ng-template [ngIf]="!isNodeEntry">\n      <mat-card class="ajf-empty"\n          cdkDropList\n          [cdkDropListEnterPredicate]="emptyAreaDropPredicate()"\n          (cdkDropListDropped)="onDropSuccess($event)">&nbsp;</mat-card>\n    </ng-template>\n  </div>\n  <ng-template [ngIf]="isNodeEntry">\n    <ajf-fb-node-entry\n        *ngFor="let childNodeEntry of realNodeEntry.children; let idx = index"\n        [level]="level"\n        [originOffset]="idx"\n        [firstBranchColor]="branchColors[idx]"\n        [nodeEntry]="childNodeEntry"></ajf-fb-node-entry>\n  </ng-template>\n</ng-container>\n<ng-template #rootEmpty>\n  <div class="mat-card-container">\n    <mat-card class="ajf-empty"\n        cdkDropList\n        [cdkDropListEnterPredicate]="emptyAreaDropPredicate()"\n        (cdkDropListDropped)="onDropSuccess($event)">&nbsp;</mat-card>\n  </div>\n</ng-template>\n',host:{"(window.resize)":"onResize()"},encapsulation:r.ViewEncapsulation.None,changeDetection:r.ChangeDetectionStrategy.OnPush,styles:["ajf-fb-node-entry{display:block;position:relative}ajf-fb-node-entry .mat-card-container{position:relative}ajf-fb-node-entry .mat-card-container .ajf-origin-line{position:absolute;top:0;left:25px;width:25px;height:25px;border-bottom:2px solid;border-left:2px solid;border-bottom-left-radius:.5em}ajf-fb-node-entry .mat-card-container mat-card{margin-left:50px;padding:.5em 1em;margin-top:.2em;margin-bottom:.2em;background-color:#fff}ajf-fb-node-entry .mat-card-container mat-card .ajf-title-row{display:flex;flex-direction:row;align-items:center}ajf-fb-node-entry .mat-card-container mat-card .ajf-title-row>.ajf-title{flex:1 1 auto}ajf-fb-node-entry .mat-card-container mat-card .ajf-title-row>.ajf-actions{flex:0 0 auto;white-space:nowrap}ajf-fb-node-entry .mat-card-container mat-card.ajf-empty{line-height:36px;border:2px dashed;box-shadow:none;box-sizing:border-box}ajf-fb-node-entry .mat-card-container.ajf-highlight>mat-card{background-color:#fff9c4}\n"]}]}],i.ctorParameters=function(){return[{type:H}]},i.propDecorators={branchLines:[{type:r.ViewChildren,args:[V]}],childEntries:[{type:r.ViewChildren,args:[i,{read:r.ElementRef}]}],isFirst:[{type:r.Input}],nodeEntry:[{type:r.Input}],level:[{type:r.Input}],originOffset:[{type:r.Input}],firstBranchColor:[{type:r.Input}]},i}(),ii=function(){function i(i,e){this.dialogRef=e,this._fields=i.flatFields.pipe(O.map((function(i){return i.sort((function(i,e){return i.name.localeCompare(e.name)}))})))}return Object.defineProperty(i.prototype,"fields",{get:function(){return this._fields},enumerable:!0,configurable:!0}),i.prototype.saveCondition=function(){null!=this.editor&&this.dialogRef.close({condition:this.editor.editedValue,errorMessage:this.errorMessage})},i.decorators=[{type:r.Component,args:[{selector:"ajf-fb-validation-condition-editor-dialog",template:'<h3 matDialogTitle translate>Edit condition</h3>\n<mat-dialog-content>\n  <mat-form-field>\n    <input matInput [(ngModel)]="errorMessage" [placeholder]="\'Error message\' | translate">\n  </mat-form-field>\n  <ajf-condition-editor\n      *ngIf="fields|async as curFields"\n      [fields]="curFields!"\n      [condition]="condition"></ajf-condition-editor>\n</mat-dialog-content>\n<mat-dialog-actions>\n  <button mat-button translate (click)="saveCondition()">Save</button>\n  <button mat-button translate matDialogClose>Close</button>\n</mat-dialog-actions>\n',encapsulation:r.ViewEncapsulation.None,changeDetection:r.ChangeDetectionStrategy.OnPush,styles:["ajf-fb-validation-condition-editor-dialog mat-dialog-content{overflow:visible}\n"]}]}],i.ctorParameters=function(){return[{type:H},{type:p.MatDialogRef}]},i.propDecorators={editor:[{type:r.ViewChild,args:[J,{static:!1}]}]},i}(),ei=function(){function i(i,e){this.dialogRef=e,this._fields=i.flatFields.pipe(O.map((function(i){return i.sort((function(i,e){return i.name.localeCompare(e.name)}))})))}return Object.defineProperty(i.prototype,"fields",{get:function(){return this._fields},enumerable:!0,configurable:!0}),i.prototype.saveCondition=function(){null!=this.editor&&this.dialogRef.close({condition:this.editor.editedValue,warningMessage:this.warningMessage})},i.decorators=[{type:r.Component,args:[{selector:"ajf-fb-warning-condition-editor-dialog",template:'<h3 matDialogTitle translate>Edit condition</h3>\n<mat-dialog-content>\n  <mat-form-field>\n    <input matInput [(ngModel)]="warningMessage"\n      [placeholder]="\'Warning message\' | translate">\n  </mat-form-field>\n  <ajf-condition-editor\n      *ngIf="fields|async as curFields"\n      [fields]="curFields!"\n      [condition]="condition"></ajf-condition-editor>\n</mat-dialog-content>\n<mat-dialog-actions>\n  <button mat-button translate (click)="saveCondition()">Save</button>\n  <button mat-button translate matDialogClose>Close</button>\n</mat-dialog-actions>\n',encapsulation:r.ViewEncapsulation.None,changeDetection:r.ChangeDetectionStrategy.OnPush,styles:["ajf-fb-warning-condition-editor-dialog mat-dialog-content{overflow:visible}\n"]}]}],i.ctorParameters=function(){return[{type:H},{type:p.MatDialogRef}]},i.propDecorators={editor:[{type:r.ViewChild,args:[J,{static:!1}]}]},i}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
i.AjfFormBuilder=K,i.AjfFormBuilderModule=si,i.AjfFormBuilderService=H,i.flattenNodes=Y,i.ɵgc_ajf_src_material_form_builder_form_builder_a=V,i.ɵgc_ajf_src_material_form_builder_form_builder_b=A,i.ɵgc_ajf_src_material_form_builder_form_builder_c=$,i.ɵgc_ajf_src_material_form_builder_form_builder_d=J,i.ɵgc_ajf_src_material_form_builder_form_builder_e=Z,i.ɵgc_ajf_src_material_form_builder_form_builder_f=X,i.ɵgc_ajf_src_material_form_builder_form_builder_g=ri,i.ɵgc_ajf_src_material_form_builder_form_builder_h=ai,i.ɵgc_ajf_src_material_form_builder_form_builder_i=G,i.ɵgc_ajf_src_material_form_builder_form_builder_j=ii,i.ɵgc_ajf_src_material_form_builder_form_builder_k=ei,Object.defineProperty(i,"__esModule",{value:!0})}));
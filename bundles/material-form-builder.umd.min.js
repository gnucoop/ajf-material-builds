...
/*! *****************************************************************************
    ...
    ***************************************************************************** */function k(i,e){var t="function"==typeof Symbol&&i[Symbol.iterator];if(!t)return i;var n,o,r=t.call(i),a=[];try{for(;(void 0===e||e-- >0)&&!(n=r.next()).done;)a.push(n.value)}catch(i){o={error:i}}finally{try{n&&!n.done&&(t=r.return)&&t.call(r)}finally{if(o)throw o.error}}return a}function I(){for(var i=[],e=0;e<arguments.length;e++)i=i.concat(k(arguments[e]));return i}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *

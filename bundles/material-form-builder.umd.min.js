...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
var M=function(i,e){return(M=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(i,e){i.__proto__=e}||function(i,e){for(var t in e)e.hasOwnProperty(t)&&(i[t]=e[t])})(i,e)};function P(i,e){var t="function"==typeof Symbol&&i[Symbol.iterator];if(!t)return i;var n,o,r=t.call(i),a=[];try{for(;(void 0===e||e-- >0)&&!(n=r.next()).done;)a.push(n.value)}catch(i){o={error:i}}finally{try{n&&!n.done&&(t=r.return)&&t.call(r)}finally{if(o)throw o.error}}return a}function k(){for(var i=[],e=0;e<arguments.length;e++)i=i.concat(P(arguments[e]));return i}var I=function(i){function e(){var e=i.call(this)||this;return e._choices=new x.BehaviorSubject([]),e._choicesObs=e._choices.asObservable(),e}return function t(i,e){function t(){this.constructor=i}M(i,e),i.prototype=null===e?Object.create(e):(t.prototype=e.prototype,new t)}(e,i),e.prototype.connect=function(){return this._choicesObs},e.prototype.disconnect=function(){},e.prototype.updateChoices=function(i){this._choices.next(i)},e}(D.DataSource),R=function(){function i(){this._displayedColumns=["label","value","delete"],this.editing={},this._choices=new I,this._choicesArr=[]}return Object.defineProperty(i.prototype,"displayedColumns",{get:function(){return this._displayedColumns},enumerable:!1,configurable:!0}),Object.defineProperty(i.prototype,"choicesOrigin",{get:function(){return this._choicesOrigin},set:function(i){this._choicesOrigin=i,this.name=i.name,this.label=i.label,this.canEditChoices=F.isChoicesFixedOrigin(i),this._choicesArr=i.choices,this._choices.updateChoices(this._choicesArr)},enumerable:!1,configurable:!0}),Object.defineProperty(i.prototype,"choices",{get:function(){return this._choices},enumerable:!1,configurable:!0}),Object.defineProperty(i.prototype,"choicesArr",{get:function(){return this._choicesArr},enumerable:!1,configurable:!0}),i.prototype.updateValue=function(i,e,t,n){this.editing[n+"-"+e]=!1,this._choicesArr[n][e]=i.target.value,this._choices.updateChoices(this._choicesArr)},i.prototype.deleteRow=function(i){this._choicesArr.splice(i,1),this._choices.updateChoices(this._choicesArr)},i.prototype.addRow=function(){this._choicesArr.push({label:"",value:""}),this._choices.updateChoices(this._choicesArr)},i}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *

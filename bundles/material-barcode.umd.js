(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ajf/core/barcode'), require('@angular/core'), require('@angular/forms'), require('@ajf/core/common'), require('@ajf/core/transloco'), require('@angular/common'), require('@angular/material/button'), require('@angular/material/button-toggle'), require('@angular/material/icon')) :
    typeof define === 'function' && define.amd ? define('@ajf/material/barcode', ['exports', '@ajf/core/barcode', '@angular/core', '@angular/forms', '@ajf/core/common', '@ajf/core/transloco', '@angular/common', '@angular/material/button', '@angular/material/button-toggle', '@angular/material/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ajf = global.ajf || {}, global.ajf.material = global.ajf.material || {}, global.ajf.material.barcode = {}), global.ajf.core.barcode, global.ng.core, global.ng.forms, global.ajf.core.common, global.ajf.core.transloco, global.ng.common, global.ng.material.button, global.ng.material.buttonToggle, global.ng.material.icon));
}(this, (function (exports, barcode, core, forms, common, transloco, common$1, button, buttonToggle, icon) { 'use strict';

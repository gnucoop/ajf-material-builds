...
(function (global, factory) {
    ...
    (global = global || self, factory((global.ajf = global.ajf || {}, global.ajf.material = global.ajf.material || {}, global.ajf.material.forms = {}), global.ajf.core.forms, global.ng.core, global.ng.material.dialog, global.rxjs.operators, global.ng.material.input, global.ng.common, global.ng.forms, global.ng.material.button, global.ng.material.card, global.ng.material.formField, global.ng.material.icon, global.ng.material.radio, global.ng.material.select, global.ng.material.slideToggle, global.ng.material.toolbar, global.ngxt.core, global.ajf.core.common, global.ajf.material.barcode, global.ajf.material.calendar, global.ajf.material.checkboxGroup, global.ajf.material.pageSlider, global.ajf.material.time));
}(this, function (exports, forms, core, dialog, operators, input, common, forms$1, button, card, formField, icon, radio, select, slideToggle, toolbar, core$1, common$1, barcode, calendar, checkboxGroup, pageSlider, time) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AjfBooleanFieldComponent = /** @class */ (function (_super) {
        ...
        AjfBooleanFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<mat-slide-toggle [formControl]=\"control|async\" [disabled]=\"readonly\"></mat-slide-toggle>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfDateInputFieldComponent = /** @class */ (function (_super) {
        ...
        AjfDateInputFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<mat-form-field><input matInput type=\"date\" [attr.aria-label]=\"instance.node.label || (instance|ajfNodeCompleteName)\" [min]=\"instance.node.minDate|ajfDateValueString\" [max]=\"instance.node.maxDate|ajfDateValueString\" [readonly]=\"readonly\" (change)=\"onChange()\" [formControl]=\"control|async\"></mat-form-field>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfMultipleChoiceFieldComponent = /** @class */ (function (_super) {
        ...
        AjfMultipleChoiceFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ng-container *ngIf=\"!(instance|ajfExpandFieldWithChoices:searchThreshold); else expanded\"><mat-select [formControl]=\"control|async\" [multiple]=\"true\" [disabled]=\"readonly\"><mat-option [value]=\"choice.value\" *ngFor=\"let choice of instance.filteredChoices\">{{ choice.label | translate }}</mat-option></mat-select></ng-container><ng-template #expanded><ajf-checkbox-group class=\"ajf-choices-container\" [formControl]=\"control|async\"><ajf-checkbox-group-item *ngFor=\"let choice of instance.filteredChoices\" [readonly]=\"readonly\" [value]=\"choice.value\">{{ choice.label | translate }}</ajf-checkbox-group-item></ajf-checkbox-group></ng-template>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },
    ...
    var AjfSingleChoiceFieldComponent = /** @class */ (function (_super) {
        ...
        AjfSingleChoiceFieldComponent.decorators = [
            { type: core.Component, args: [{template: "<ng-container *ngIf=\"!(instance|ajfExpandFieldWithChoices:searchThreshold) ; else expanded\"><mat-select [formControl]=\"control|async\" [disabled]=\"readonly\"><mat-option [value]=\"choice.value\" *ngFor=\"let choice of instance.filteredChoices\">{{ choice.label | translate }}</mat-option></mat-select></ng-container><ng-template #expanded><mat-radio-group class=\"ajf-choices-container\" [formControl]=\"control|async\"><mat-radio-button [value]=\"choice.value\" [disabled]=\"readonly\" *ngFor=\"let choice of instance.filteredChoices\">{{ choice.label | translate }}</mat-radio-button></mat-radio-group></ng-template>",
                        styles: [""],
                        changeDetection: core.ChangeDetectionStrategy.OnPush,
                        encapsulation: core.ViewEncapsulation.None,
                    },] },

...
/**
     ...
     *
     */
var J=function(){function e(){}return e.forRoot=function(){return{ngModule:e,providers:[G]}},e}();J.decorators=[{type:a.NgModule,args:[{imports:[s.AjfBarcodeModule,f.AjfCalendarModule,c.AjfCommonModule,n.AjfFormsModule,d.AjfCheckboxGroupModule,m.AjfPageSliderModule,p.AjfTimeModule,j.CommonModule,h.MatButtonModule,y.MatCardModule,t.MatDialogModule,b.MatFormFieldModule,I.MatIconModule,o.MatInputModule,C.MatRadioModule,v.MatSelectModule,F.MatSlideToggleModule,A.MatToolbarModule,u.ReactiveFormsModule,g.TextFieldModule,x.TranslateModule],declarations:[N,D,M,w,E,R,W,H,O,P,k,V,B,q,L],entryComponents:[N,D,M,w,E,O,P,k,V,B,q,L],exports:[W,H],providers:[G,{provide:n.AJF_WARNING_ALERT_SERVICE,useClass:T}]}]}],
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *

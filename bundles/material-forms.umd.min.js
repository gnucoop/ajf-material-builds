...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var R,S=function(e,n){return(S=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,n){e.__proto__=n}||function(e,n){for(var a in n)n.hasOwnProperty(a)&&(e[a]=n[a])})(e,n)};function _(e,n){function a(){this.constructor=e}S(e,n),e.prototype=null===n?Object.create(n):(a.prototype=n.prototype,new a)}(R=function R(){}).decorators=[{type:a.Component,args:[{template:'<mat-dialog-content><div [innerHTML]="message"></div></mat-dialog-content>\n<mat-dialog-actions>\n  <button mat-button [mat-dialog-close]="true">Ok</button>\n  <button mat-button [mat-dialog-close]="false">Cancel</button>\n</mat-dialog-actions>\n',changeDetection:a.ChangeDetectionStrategy.OnPush,encapsulation:a.ViewEncapsulation.None}]}];
/**
     * @license
...
/**
     ...
     *
     */
var J=function(){function e(){}return e.forRoot=function(){return{ngModule:e,providers:[G]}},e}();J.decorators=[{type:a.NgModule,args:[{imports:[s.AjfBarcodeModule,f.AjfCalendarModule,c.AjfCommonModule,n.AjfFormsModule,d.AjfCheckboxGroupModule,m.AjfPageSliderModule,p.AjfTimeModule,j.CommonModule,h.MatButtonModule,y.MatCardModule,t.MatDialogModule,b.MatFormFieldModule,I.MatIconModule,o.MatInputModule,C.MatRadioModule,v.MatSelectModule,A.MatSlideToggleModule,F.MatToolbarModule,u.ReactiveFormsModule,g.TextFieldModule,x.TranslateModule],declarations:[N,D,w,M,E,R,W,H,O,P,k,V,B,q,L],entryComponents:[N,D,w,M,E,O,P,k,V,B,q,L],exports:[W,H],providers:[G,{provide:n.AJF_WARNING_ALERT_SERVICE,useClass:T}]}]}],
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *

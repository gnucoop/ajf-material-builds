...
import * as i2$1 from '@ajf/material/monaco-editor';
import { AjfMonacoEditor, AjfMonacoEditorModule } from '@ajf/material/monaco-editor';
import * as i3$2 from '@ajf/material/node-icon';
